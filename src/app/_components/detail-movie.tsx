...
export function DetailMovieComponent({mediaType, id, detail, credits}: DetailPageComponentProps) {
            ...
            <div className="relative w-full h-[500px] rounded-xl overflow-hidden">
              ...
              <div className="absolute bottom-6 left-6 flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-300 mt-2">{detail.releaseDate} • {renderDurata()} • {renderGenere()} </p>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="text-gray-300 space-y-2">
                  ...
                  <li><strong>Data di Rilascio:</strong> {detail.releaseDate}</li>
